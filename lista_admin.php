<html>
	<head><title>Lista de automoviles</title>
  ...
  <br><h2 align="center">Lista Autos</h2>
	<table>
	<th width="920px" style="padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 150px"></th>
	</table>
  <div class="container">
...
function onclickHandler() {
        if(seleccionado==this) {
            ...
            this.style.backgroundColor="#86F1C1";
            seleccionado=this;
        }
    }
...
function eliminar() {
    if(seleccionado==null) return alert("Seleccione sobre el auto qu desea eliminar");
